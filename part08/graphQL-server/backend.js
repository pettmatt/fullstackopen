...
const resolvers = {
  Query: {
    ...
    allBooks: (root, args) => {
      ...
      else if(args.genre) return books.filter(b => b.genres.includes(args.genre))
      else if(args.author && args.genre) return books
  ...
  Mutation: {
    addBook: (root, args) => {
      if(books.find(b => b.title === args.title))
        throw new UserInputError('Title of the book must be unique', { invalidArgs: args.title })
