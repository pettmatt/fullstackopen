describe('Blog app', function () {
	...
	describe('When logged in', function () {
		...
		it('a blog can be liked', function () {
			...
			cy.visit('http://localhost:3000')
			cy.contains('This is a title').contains('Extend').click()
			cy.contains('likes: 1')
		})
		...
		it('can delete own blogs', function () {
			...
			cy.contains('Try to delete this, Fake Author').contains('Extend').click()
			cy.contains('remove').should('not.exist')

			cy.contains('But delete this, Petteri Mattila').contains('Extend').click()
